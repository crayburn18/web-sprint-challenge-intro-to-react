...
1. What is React JS and what problems does it solve? Support your answer with concepts introduced in class and from your personal research on the web.
  ...
  React is a javascript library that allows us to make reusable UI components which allows for easier changes to the UI in the future.

1. Describe component state.

Component state is an object that determines how the component will act

1. Describe props.

props is data that is passed from parent to child components and can never got child to parent.

1. What are side effects, and how do you sync effects in a React component to changes of certain state or props?

Side effects are any state changes done outside of the return and syn effects with useEffect
